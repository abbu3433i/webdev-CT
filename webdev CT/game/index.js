...
// // }
// //   let user=true
// //   user?console.log('hello'):console.log('hiii byteee')
...
//     //  let arr=[{id:1,user:'hello'},{id:2,user:'hiii'}]
